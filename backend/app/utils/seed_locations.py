...
locations_data = [
    ...
    { "name": "SVU College of Commerce, Management & Computer Science", "category": "Constituent Colleges" },
    { "name": "SVU College of Pharmaceutical Sciences", "category": "Constituent Colleges" },
    { "name": "Dr. B.R. Ambedkar Law College (Department of Law)", "category": "Constituent Colleges" },
    { "name": "Administrative Building (Neelam Sanjeeva Reddy Bhavan)", "category": "Administration" },
    ...
    { "name": "Dept. of Computer Science & Engineering (CSE)", "category": "Engineering Departments" },
    { "name": "Dept. of Electronics & Communication Engineering (ECE)", "category": "Engineering Departments" },
    { "name": "Dept. of Electrical & Electronics Engineering (EEE)", "category": "Engineering Departments" },
    ...
    { "name": "Dept. of Political Science & Public Administration", "category": "Arts & Humanities" },
    ...
    { "name": "SVU Ladies Hostel (Main Block - Premises I)", "category": "Women's Hostels" },
