...
ALLOWED_DOMAINS = ["gmail.com", "outlook.com", "hotmail.com", "yahoo.com", "zoho.com", "zoho.in"]
...
def probe_email_authenticity(email: str, timeout: int = 5) -> Tuple[Optional[bool], str]:
    """
    ...
    try:
        ...
        if code == 250:
            ...
            return False, f"This email address does not seem to exist on {domain.capitalize()}."
        else:
